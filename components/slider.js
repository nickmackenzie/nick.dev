...
export default function Slider() {
  ...
  const slides = [
    {
      img: "/images/screenshot-rocks.svg",
      label: "",
      description: `A Full Stack App using MongoDB as a backend and ReactJS with TailwindCSS as a front-end. 
      This app always user to create their own account and set a personal code.`,
    },
    {
          ...
          {slides.map((slide, sid) => (
            <Box key={`slide-${sid}`} boxSize="full" shadow="md" flex="none">
              <Flex>
                ...
                <Image src={slide.img} width="400px" backgroundSize="cover" />
...
//           TailwindCSS as a front-end. This app always user to create their
//           own account and set a personal code.
//         </Box>
